...
func request_Example_Call_0(ctx context.Context, marshaler runtime.Marshaler, client ExampleClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Example_Call_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_Example_Call_0(ctx context.Context, marshaler runtime.Marshaler, server ExampleServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Request
	var metadata runtime.ServerMetadata
...
func RegisterExampleHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ExampleServer) error {
	...
	mux.Handle("GET", pattern_Example_Call_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Example_Call_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_Example_Call_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"call"}, "", runtime.AssumeColonVerbOpt(true)))
)
